...
public class ModItems {
    ...
    public static final Item IMPULSE_WAND = new ImpulseWandItem(new Item.Settings().maxCount(1).maxDamage(200));
    ...
    public static final ItemGroup STARDANCE_UTILS = new ItemGroup.Builder(ItemGroup.Row.TOP, 1)
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(IMPULSE_WAND);
            })
            .build();

    public static void registerItems() {
        Registry.register(Registries.ITEM, new Identifier(Stardance.MOD_ID, "grid_creator"), GRID_CREATOR);
        Registry.register(Registries.ITEM, new Identifier(Stardance.MOD_ID, "impulse_wand"), IMPULSE_WAND);
